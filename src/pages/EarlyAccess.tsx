...
const copy = {
  bg: {
    ...
    benefits: [
      ...
      { title: "90-дневен безплатен пробен период", desc: "Всички пакети започват с 90 дни безплатно." },
    ],
  ...
  en: {
    ...
    benefits: [
      ...
      { title: "90-day free trial", desc: "Every plan starts with 90 days free." },
    ],
